...
struct AdvancedPromptElement{
    PromptElementType elementType;
};

ScriptAdvancedPrompt::ScriptAdvancedPrompt(QWidget *parent): QDialog(parent)
{
    setupUi(this);
    ...
    // connect(donateButton, &QAbstractButton::clicked, this, &ScriptAdvancedPrompt::donate);
